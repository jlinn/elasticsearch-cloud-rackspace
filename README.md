...
```
bin/plugin --url https://github.com/jlinn/elasticsearch-cloud-rackspace/releases/download/v0.2.0/elasticsearch-cloud-rackspace-0.2.0.zip --install cloud-rackspace
```
